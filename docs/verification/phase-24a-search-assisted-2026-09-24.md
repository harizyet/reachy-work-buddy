...
## Addendum — hosted provider rotation and multi-turn check (2026-09-25)

Follow-up work found during Phase 24d. Homelab core ran the provider rotation (`0144209`), follow-up search and
...
- **Latency.** Search took 0.7–2.7 s. Whole core turns took 5–9 s for text
  and 7–16.5 s for voice weather, which is over 24d's non-search p95 8 s budget; search turns get their own 24d
  budget. The
