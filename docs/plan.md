...
physical acceptance, must pass before Phase 25 (owner recognition).
Phases 24d and 25–27 remain open or planned;
...
9. Pass [Phase 24d](phase-24cd.md#phase-24d--physical-end-to-end-acceptance): prove the full multi-turn workflow on real Reachy hardware before starting Phase 25.
