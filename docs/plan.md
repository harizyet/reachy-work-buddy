...
Phase 23 is in progress: migrations and SecretStore are implemented and
verified in isolation; Google Accounts remain next. Phase 22b and Phase 24
...
3. Continue Phase 23 with the account-integration ADR, Google setup, Accounts UI and read-only adapters. The migrations/SecretStore foundation is implemented; production cutover and real-account acceptance remain open. See [foundation evidence](verification/phase-23-foundation-2026-09-23.md).
