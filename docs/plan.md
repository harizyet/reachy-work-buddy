...
Nano hardware availability). See the [bring-up record](verification/phase-22-bring-up.md) for evidence.
...
production-audience and deferred physical acceptance remain open. Phase 22b and Phase 24
...
| Phase 26 — Delegated meeting attendance and secretary | Disclosed virtual attendance, private notes and owner-question forwarding via Telegram or another bound private channel (26a), bounded approved secretary participation (26b), and Reachy in physical meetings while the owner is unavailable (26c); see the [delegation plan](phase-26.md). | Real owner-absent calls produce evidence-linked minutes; grants, recovery and privacy gates pass; the platform never answers for the owner or makes commitments; physical attendance passes a separate ADR amendment and supervised hardware acceptance. Planned, not implemented; builds on Phase 25, with Phase 22b/24 required for physical use. |
...
3. Complete Phase 23 production acceptance: register the Google application for the intended audience, deploy with HTTPS, run real-account consent/read/refresh/revoke/reconnect/restore checks. Implementation and isolated functional checks are complete; see [Accounts evidence](verification/phase-23-accounts-2026-09-23.md).
...
8. Implement Phase 26 in separately accepted stages: virtual attendance, bounded secretary participation, then physical delegation; prove provider feasibility and the owner-absent permission boundary first. See the [delegation plan](phase-26.md).
