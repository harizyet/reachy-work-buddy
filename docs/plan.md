...
| 24f | Draft plan | Motion conformance, verified startup home, local conversation animation | Version audit and supervised physical acceptance required; enabled changes must pass before Phase 25 uses them | [Scope and exit](phase-24f.md#delivery-sequence-and-exit) |
