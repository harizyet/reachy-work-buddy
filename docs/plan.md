...
| 24f | In progress; blocked on hardware | Motion conformance, verified startup home, local conversation animation | REST/SDK parity measured; robot stops 2–5° short on both (normal vs fault open). Motion owner implemented, off by default. Enabled changes must pass before Phase 25 uses them | [Scope and exit](phase-24f.md#delivery-sequence-and-exit) |
