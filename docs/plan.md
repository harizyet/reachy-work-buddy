...
physical acceptance, has been in progress since 2026-09-24 and must pass
before Phase 25 (owner recognition). Phases 24d and 25–27 remain open or
planned;
...
| Phase 24d — Physical conversation acceptance | Exercise the complete 24c workflow on the real robot with real speech/model providers, multi-turn context, channel handoff, privacy, cancellation and recovery; see the [acceptance matrix](phase-24cd.md#phase-24d--physical-end-to-end-acceptance). | Every required matrix row passes with measured hardware evidence and owner-accepted usability before Phase 25 begins; fixtures or standalone microphone/speaker checks cannot close this gate. In progress since 2026-09-24: real mic → STT → LLM → TTS → speaker conversation demonstrated on the robot; the formal matrix and a Nano cold-reboot recovery check remain open ([record](verification/phase-24d-conversation-2026-09-24.md)). Answer accuracy of search-assisted turns is 24a scope. |
