...
Nano hardware availability). **22c — camera LOCAL-backend acceptance**
...
See the [bring-up record](verification/phase-22-bring-up.md) for evidence.
...
Phase 23's open real-account acceptance item rather than closing it. Phase 22b and Phase 24
